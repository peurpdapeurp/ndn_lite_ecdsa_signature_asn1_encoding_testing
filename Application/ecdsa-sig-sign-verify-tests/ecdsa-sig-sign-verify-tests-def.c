...
#include "curve-specific/test-secp160r1-def.h"
#include "curve-specific/test-secp192r1-def.h"
#include "curve-specific/test-secp224r1-def.h"
#include "curve-specific/test-secp256r1-def.h"
#include "curve-specific/test-secp256k1-def.h"
...
char *ecdsa_sig_sign_verify_test_names[ECDSA_SIGN_VERIFY_NUM_TESTS] = {
  ...
  "test_keypair_secp256k1_1",
  "test_keypair_secp256k1_2",
  "test_keypair_secp256k1_3",
  "test_keypair_secp256k1_4",
  "test_keypair_secp224r1_1",
  "test_keypair_secp224r1_2",
  "test_keypair_secp224r1_3",
  "test_keypair_secp224r1_4",
...
ecdsa_sig_sign_verify_test_t ecdsa_sig_sign_verify_tests[ECDSA_SIGN_VERIFY_NUM_TESTS] = {
    ...
    },
    {
      ...
      &ecdsa_sig_sign_verify_test_results[12]
    },
    {
      ecdsa_sig_sign_verify_test_names,
      13,
      ...
      &ecdsa_sig_sign_verify_test_results[13]
    },
    {
      ecdsa_sig_sign_verify_test_names,
      14,
      ...
      &ecdsa_sig_sign_verify_test_results[14]
    },
    {
      ecdsa_sig_sign_verify_test_names,
      15,
      ...
      &ecdsa_sig_sign_verify_test_results[15]
    },
    {
      ecdsa_sig_sign_verify_test_names,
      16,
      ...
      &ecdsa_sig_sign_verify_test_results[16]
    },
    {
      ecdsa_sig_sign_verify_test_names,
      17,
      ...
      &ecdsa_sig_sign_verify_test_results[17]
    },
    {
      ecdsa_sig_sign_verify_test_names,
      18,
      ...
      &ecdsa_sig_sign_verify_test_results[18]
    },
    {
      ecdsa_sig_sign_verify_test_names,
      19,
      ...
      &ecdsa_sig_sign_verify_test_results[19]
    },
};
