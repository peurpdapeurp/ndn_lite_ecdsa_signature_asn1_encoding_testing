...
#ifndef BASIC_ASN_ENCODE_DECODE_TESTS_DEF_H
#define BASIC_ASN_ENCODE_DECODE_TESTS_DEF_H

#include "basic-asn-encode-decode-tests.h"

#define BASIC_ASN_ENCODE_DECODE_NUM_TESTS 8

extern char *basic_asn_encode_decode_test_names[BASIC_ASN_ENCODE_DECODE_NUM_TESTS];

extern bool basic_asn_encode_decode_test_results[BASIC_ASN_ENCODE_DECODE_NUM_TESTS];

extern basic_asn_encode_decode_test_t basic_asn_encode_decode_tests[BASIC_ASN_ENCODE_DECODE_NUM_TESTS];
...
#endif // BASIC_ASN_ENCODE_DECODE_TESTS_DEF_H